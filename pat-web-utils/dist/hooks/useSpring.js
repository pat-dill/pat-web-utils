...
function useSpring(goal, damping = 1, speed = 10) {
    const [position, setPosition] = (0, react_1.useState)(goal);
    const springRef = (0, react_1.useRef)({
        prevDisplacement: 0,
        prevVelocity: 0,
        velocity: 0,
        displacement: 0,
    ...
    const animate = () => {
        const [posPos, posVel, velPos, velVel] = springCoefficients(getSeconds() - spring.lastUpdate, spring.damping, spring.speed);
