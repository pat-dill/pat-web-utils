...
exports.useImageColorFromUrl = exports.useImageColor = exports.getImageColor = void 0;
...
function useImageColor(imgRef) {
    ...
    (0, react_1.useEffect)(() => {
        ...
        if (imgRef.current.complete) {
            setColor((0, exports.getImageColor)(imgRef.current));
        }
        else {
...
function useImageColorFromUrl(url) {
    const { data, isLoading, error, refetch } = (0, react_query_1.useQuery)(["image-color", url], () => {
        return new Promise((resolve, reject) => {
            ...
            img.onload = () => {
                try {
                    resolve((0, exports.getImageColor)(img));
                }
                catch (e) {
                    reject(e);
                }
